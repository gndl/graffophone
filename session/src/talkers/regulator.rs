...
impl Regulator {
    pub fn new(mut base: TalkerBase) -> Result<CTalker, failure::Error> {
        let stem_set = Set::from_attributs(&vec![
            ...
            ("proportional", PortType::Cv, 0., 10., 1., Init::DefValue),
            ("integral", PortType::Cv, 0., 10., 0., Init::DefValue),
            ("derivative", PortType::Cv, 0., 10., 0., Init::DefValue),
        ])?;
