...
fn test_event_note() {
    ...
    assert_eq!(Event::note(0, 8.1758, 1, 0.5, 2, 0.4, true),
        (Event {
            ...
            sysex: Some(vec![0xF0, 0x7E, 0x7F, 0x08, 0x07, 0x00, 0x00, 0x01, 0, 0, 0, 0, 0xF7]),
        },
        Event {
            tick: 2,
    ...
    assert_eq!(Event::note(0, 8.17585, 1, 1., 2, 0., true),
        (Event {
            ...
            sysex: Some(vec![0xF0, 0x7E, 0x7F, 0x08, 0x07, 0x00, 0x00, 0x01, 0, 0, 0, 1, 0xF7]),
        },
        Event {
            tick: 2,
    ...
    assert_eq!(Event::note(0, 8.66196, 1, 1., 2, 0., true),
        (Event {
            ...
            sysex: Some(vec![0xF0, 0x7E, 0x7F, 0x08, 0x07, 0x00, 0x00, 0x01, 1, 1, 0, 0, 0xF7]),
        },
        Event {
            tick: 2,
    ...
    assert_eq!(Event::note(0, scl_12et.pitch_name_to_frequency("C0").unwrap(), 1, 1., 2, 0., true),
        (Event {
            ...
            sysex: Some(vec![0xF0, 0x7E, 0x7F, 0x08, 0x07, 0x00, 0x00, 0x01, 0x0C, 0x0C, 0, 0, 0xF7]),
        },
        Event {
            tick: 2,
    ...
    assert_eq!(Event::note(0, scl_12et.pitch_name_to_frequency("C4").unwrap(), 1, 1., 2, 0., true),
        (Event {
            ...
            sysex: Some(vec![0xF0, 0x7E, 0x7F, 0x08, 0x07, 0x00, 0x00, 0x01, 0x3C, 0x3C, 0, 0, 0xF7]),
        },
        Event {
            tick: 2,
    ...
    assert_eq!(Event::note(0, scl_12et.pitch_name_to_frequency("C#4").unwrap(), 1, 1., 2, 0., true),
        (Event {
            ...
            sysex: Some(vec![0xF0, 0x7E, 0x7F, 0x08, 0x07, 0x00, 0x00, 0x01, 0x3D, 0x3D, 0, 0, 0xF7]),
        },
        Event {
            tick: 2,
    ...
    assert_eq!(Event::note(0, 439.9984, 1, 0.5, 2, 0.4, true),
        (Event {
            ...
            sysex: Some(vec![0xF0, 0x7E, 0x7F, 0x08, 0x07, 0x00, 0x00, 0x01, 0x45, 0x44, 0x7F, 0x7E, 0xF7]),
        },
        Event {
            tick: 2,
    ...
    assert_eq!(Event::note(0, scl_12et.pitch_name_to_frequency("A4").unwrap(), 1, 1., 2, 0., true),
        (Event {
            ...
            sysex: Some(vec![0xF0, 0x7E, 0x7F, 0x08, 0x07, 0x00, 0x00, 0x01, 0x45, 0x45, 0, 0, 0xF7]),
        },
        Event {
            tick: 2,
    ...
    assert_eq!(Event::note(0, 440.0016, 1, 0.5, 2, 0.4, true),
        (Event {
            tick: 1,
            data: vec![NOTE_ON, 0x45, 63],
            sysex: Some(vec![0xF0, 0x7E, 0x7F, 0x08, 0x07, 0x00, 0x00, 0x01, 0x45, 0x45, 0x00, 0x01, 0xF7]),
        },
        Event {
            tick: 2,
            data: vec![NOTE_OFF, 0x45, 50],
    ...
    assert_eq!(Event::note(0, scl_12et.pitch_name_to_frequency("C9").unwrap(), 1, 1., 2, 0., true),
        (Event {
            ...
            sysex: Some(vec![0xF0, 0x7E, 0x7F, 0x08, 0x07, 0x00, 0x00, 0x01, 0x78, 0x78, 0, 0, 0xF7]),
        },
        Event {
            tick: 2,
    ...
    assert_eq!(Event::note(0, 8372.0630, 1, 1., 2, 0., true),
        (Event {
            tick: 1,
            data: vec![NOTE_ON, 0x78, 127],
            sysex: Some(vec![0xF0, 0x7E, 0x7F, 0x08, 0x07, 0x00, 0x00, 0x01, 0x78, 0x78, 0, 1, 0xF7]),
        },
        Event {
            tick: 2,
            data: vec![NOTE_OFF, 0x78, 0],
    ...
    assert_eq!(Event::note(0, scl_12et.pitch_name_to_frequency("G9").unwrap(), 1, 1., 2, 0., true),
        (Event {
            ...
            sysex: Some(vec![0xF0, 0x7E, 0x7F, 0x08, 0x07, 0x00, 0x00, 0x01, 0x7F, 0x7F, 0, 0, 0xF7]),
        },
        Event {
            tick: 2,
    ...
    assert_eq!(Event::note(0, 13289.7, 1, 0.5, 2, 0.4, true),
        (Event {
            ...
            sysex: Some(vec![0xF0, 0x7E, 0x7F, 0x08, 0x07, 0x00, 0x00, 0x01, 0x7F, 0x7F, 0x7F, 0x7E, 0xF7]),
        },
        Event {
            tick: 2,
