...
use crate::gpplugin::talker::Talker;
...
pub struct Session {
    ...
    //  tracks : HashMap<u32, RTrack>,
    mixers: HashMap<u32, Mixer>,
    //  outputs : HashMap<u32, RAudioOutput>,
}
...
impl Session {
    pub fn new(filename: String) -> Session {
        let mut session = Self {
            filename,
            talkers: HashMap::new(),
            mixers: HashMap::new(),
        };
        let mixer = Mixer::new(vec![Track::new()], 2);
