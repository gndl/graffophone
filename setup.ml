...
(* OASIS_START *)
(* DO NOT EDIT (digest: 15aa110445f9b1223e28bb246633ef9a) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis = "A modular audio processor";
          description = None;
          categories = [];
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Talker"; "Listen"; "Plugin"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "plugin";
                      lib_findlib_containers = ["graffophone"]
                   });
               Library
                 ({
                     cs_name = "graffophone-plugins";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [InternalLibrary "graffophone-plugin"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("ao", None);
                           FindlibPackage ("lablgtk2", None);
                           FindlibPackage ("lablgtk2.glade", None);
                           FindlibPackage ("lablgtk2.gnomecanvas", None);
                           InternalLibrary "graffophone-plugin"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/gndl/graffophone.git";
                      src_repo_browser =
                        Some "https://github.com/gndl/graffophone";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\237\131\176B;\014'\137\137\018\005\156\019\130_D";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
